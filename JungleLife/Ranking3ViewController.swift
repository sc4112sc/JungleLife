...
class Ranking3ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.imageView?.image = UIImage(named:  "Bat1")
            ...
            cell.imageView?.image = UIImage(named:  "Donkey1")
        } else {
            if rankStatus == false {
            ...
            cell.imageView?.image = UIImage(named:  "Crow1")
        }
        return cell
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //
        myJsonData = []
        let urlStr = "https://sheetdb.io/api/v1/yidip89pry1u5".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)
...
//                        for p in jsonObj {
//
//                            self.myJsonData.append((p["Name"] as! String,p["Score"] as! String,p["Id"] as! String,p["Level"] as! String))
//                        }
//
//                    }
//                } catch {
